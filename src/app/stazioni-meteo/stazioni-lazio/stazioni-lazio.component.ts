...
export class StazioniLazioComponent implements OnInit {
  ...
  constructor(private meta: Meta) {
    this.meta.addTags([
      ...
      {
        name: 'keywords',
        content: 'temperature lazio, meteo campoli lazio, temperature lazio meteo campoli, temperature stazioni meteo lazio, stazioni meteo lazio, stazioni meteo lazio meteo campoli'
      },
