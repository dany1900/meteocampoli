...
@Component({
  selector: 'satellite-test',
  templateUrl: './satellite-test.component.html',
  styleUrls: ['./satellite-test.component.css']
})
export class SatelliteTestComponent implements OnInit {
