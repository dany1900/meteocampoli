...
@Component({
  selector: 'pesco',
  templateUrl: './pesco.component.html',
  styleUrls: ['./pesco.component.css']
})
export class PescoComponent implements OnInit, OnChanges {
  ...
  constructor(protected router: Router, private seo: SEOService, public utilityService: UtiliyService) {
    ...
    this.ogUrl = 'www.meteocampoli.altervista.org/info/articoli/giardinaggio/pesco';
    this.ogImage = '';
