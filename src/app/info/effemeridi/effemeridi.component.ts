...
export class EffemeridiComponent implements OnInit {
  ...
  constructor(private meta: Meta, private titleService: Title) {
    titleService.setTitle('Orari Alba Tramonto - Meteo Campoli');
    this.meta.updateTag({
      name: 'description',
    ...
    this.meta.updateTag({property: 'og:title', content: 'Orari Alba Tramonto - Meteo Campoli'});
    this.meta.updateTag({
      property: 'og:description',
      content: 'Monitoraggio del Sole con dati. Analisi e previsioni sulla qualità dell\'aria. Statistiche sulle medie regionali italiane. Effemeridi Campoli App'
    });
    this.meta.updateTag({property: 'og:url', content: 'www.meteocampoli.altervista.org/webcam/info/effemeridi'});
    this.meta.updateTag({
