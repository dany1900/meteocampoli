...
@Component({
  selector: 'tab-isole-webcam',
  templateUrl: './tab-isole-webcam.component.html',
  styleUrls: ['./tab-isole-webcam.component.css']
})
export class TabIsoleWebcamComponent implements OnInit {
