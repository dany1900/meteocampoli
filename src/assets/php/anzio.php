...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=ILAZIOAN3");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.meteolavinio.it/dati-meteo" target="_blank">Anzio (RM)</a></strong></li>
