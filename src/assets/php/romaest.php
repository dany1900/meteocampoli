...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=ILAZIORO18");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.wunderground.com/weatherstation/WXDailyHistory.asp?ID=ILAZIORO18" target="_blank">Roma Est  <br> (90 mt)</a></strong></li>
