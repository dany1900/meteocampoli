...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=ITERAMOP5");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://pineto.abruzzometeo.it/" target="_blank">Pineto (TE) <br> (0 mt)</a></strong></li>
