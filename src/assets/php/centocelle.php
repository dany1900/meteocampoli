...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=IRMROME5");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.meteocentocelle.it/" target="_blank">CENTOCELLE (RM) <br> (72 mt)</a></strong></li>
