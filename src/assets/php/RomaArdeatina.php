...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=IROMAROM3");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.wunderground.com/personal-weather-station/dashboard?ID=IROMAROM3#history" target="_blank">Roma <br> Ardeatina</a></strong></li>


</h2><h4><?php echo($cut_string = substr($xml-> observation_time, 15 ,-5)); ?></h4>
