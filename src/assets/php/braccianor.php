...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=IROMABRA2");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.wunderground.com/weatherstation/WXDailyHistory.asp?ID=IROMABRA2" target="_blank">Bracciano (RM)  <br> (163 mt)</a></strong></li>
