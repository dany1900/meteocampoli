...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=ILAZIOVE6");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.wunderground.com/personal-weather-station/dashboard?ID=ILAZIOVE6" target="_blank">Vetozza (RI) <br> (951 mt)</a></strong></li>
