...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=ILAZIOIS2");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.meteoliri.it/stmetisola1.php" target="_blank">Isola Liri <br> (269mt)</a></strong></li>
