...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=ILAZIOAR10");
...
<body>
				...
				<div style="text-align: center"><h2><a href="https://www.wunderground.com/personal-weather-station/dashboard?ID=ILAZIOAR10" target="_blank">Ariccia (RM) <br> (487 mt)</a></h2>
