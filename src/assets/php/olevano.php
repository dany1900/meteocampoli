...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=IROMAOLE2");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://my.meteonetwork.it/station/laz176/" target="_blank">Olevano (RM) <br> (540 mt)</a></strong></li>
