...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=ILAZIOCA7");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://meteocampoli.altervista.org/riepilogo.htm" target="_blank">Campoli Appennino <br> (500 mt)</a></h2>
