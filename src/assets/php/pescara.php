...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=IABRUZZO1");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.pescarameteo.net/" target="_blank">Pescara <br> (0 mt)</a></strong></li>
