...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=IALVITO3");
...
<body>
				...
				<div style="text-align: center"><h2><a href="https://www.wunderground.com/personal-weather-station/dashboard?ID=IALVITO3" target="_blank">Alvito <br> (495mt)</a></h2>
