...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=IABRUZZO10");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://my.meteonetwork.it/station/abr040/" target="_blank">Torrevecchia T. (CH)<br> (200 mt)</a></strong></li>
