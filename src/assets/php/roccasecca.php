...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=ILAZIORO31");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://my.meteonetwork.it/station/laz097/" target="_blank">Roccasecca <br> (250 mt)</a></strong></li>
