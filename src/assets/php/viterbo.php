...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=IVITERBO17");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.wunderground.com/weatherstation/WXDailyHistory.asp?ID=ILAZIOVI10" target="_blank">Viterbo <br> (358 m) </a></strong></li>
