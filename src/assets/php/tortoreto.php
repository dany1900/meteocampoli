...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=ITERAMOT7");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.meteotortoreto.it/" target="_blank">Tortoreto (TE) <br> (200 mt)</a></strong></li>
