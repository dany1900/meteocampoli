...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=ILAZIOPO4");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.pomeziameteo.altervista.org/" target="_blank">Pomezia (RM) <br> (80 mt)</a></strong></li>
