...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=ILAZIOPO3");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.wunderground.com/weatherstation/WXDailyHistory.asp?ID=ILAZIOPO3" target="_blank">Pontecorvo (FR) <br> (97m)</a></strong></li>
