...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=IABRUZZO48");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.mastromario.it/stazionemeteo/lanciano.htm" target="_blank">Lanciano (CH) <br> (255 mt)</a></strong></li>
