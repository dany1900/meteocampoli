...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=ILAZIOFI2");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.wunderground.com/personal-weather-station/dashboard?ID=ILAZIOFI2" target="_blank">Fiumicino (RM) </a></strong></li>
