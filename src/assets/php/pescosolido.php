...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=ILAZIOPE2");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.pescosolidometeo.altervista.org/" target="_blank">Pescosolido <br> (550 mt)</a></strong></li>
