...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=IROMARIG2");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.meteomorlupo.it/joomla/index.php/home" target="_blank">MORLUPO (RM) <br> (250 mt)</a></strong></li>
