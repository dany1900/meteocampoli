...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=IRIETINE2");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.wunderground.com/weatherstation/WXDailyHistory.asp?ID=IRIETINE2" target="_blank">NESCE (RI) <br> (725 mt)</a></strong></li>
