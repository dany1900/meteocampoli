...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=ILAQUILA4");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.caputfrigoris.it/rete-meteo.htm" target="_blank">AVEZZANO <br> (700 mt)</a></strong></li>
