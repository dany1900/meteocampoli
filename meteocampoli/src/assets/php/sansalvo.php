...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=IABRUZZO36");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.caputfrigoris.it/rete-meteo/sansalvo.htm" target="_blank">San Salvo (CH) <br> (100 mt)</a></strong></li>
