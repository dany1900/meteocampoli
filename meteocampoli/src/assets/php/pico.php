...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=ILAZIOPI2");
...
<body>
				...
				<div style="text-align: center"><h2><a href="https://www.wunderground.com/personal-weather-station/dashboard?ID=ILAZIOPI2" target="_blank">Pico (FR) <br> (114mt)</a></h2>
