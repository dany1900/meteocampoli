...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=ILAZIOSU2");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.subiacometeo.altervista.org/subiaco.htm" target="_blank">Subiaco (RM) <br> (500 mt)</a></strong></li>
