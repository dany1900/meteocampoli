...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=IABRUZZO91");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.wunderground.com/personal-weather-station/dashboard?ID=IABRUZZO91" target="_blank">Carapelle Carlvisio (AQ) <br> (900 mt)</a></strong></li>
