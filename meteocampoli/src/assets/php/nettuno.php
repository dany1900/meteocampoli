...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=ILAZIONE3");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.wunderground.com/personal-weather-station/dashboard?ID=ILAZIONE3" target="_blank">Nettuno (RM) <br> (14 mt)</a></strong></li>
