...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=IMOLISEC3");
...
<body>
				...
				<div style="text-align: center"><h2><a href="https://www.wunderground.com/personal-weather-station/dashboard?ID=IMOLISEC3" target="_blank">Capracotta (IS) <br> (1391mt)</a></h2>
