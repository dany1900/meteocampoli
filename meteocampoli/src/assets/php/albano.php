...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=ILAZIOAL5");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.albanometeo.it/statistiche.htm" target="_blank">Albano Laziale (RM) <br> (205 mt)</a></strong></li>
