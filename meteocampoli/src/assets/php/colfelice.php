...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=IFROSINI2");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://www.meteocolfelice.altervista.org/" target="_blank">Colfelice (FR) <br> (158 mt)</a></strong></li>
