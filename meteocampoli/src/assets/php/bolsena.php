...
$xml = simplexml_load_file("http://api.wunderground.com/weatherstation/WXCurrentObXML.asp?ID=ILAZIOVI21");
...
<body>
				...
				<div style="text-align: center"><h2><a href="http://my.meteonetwork.it/station/laz115/" target="_blank">Bolsena (VT) <br> (308 mt)</a></strong></li>
